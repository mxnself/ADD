...
from torch.nn.modules import AdaptiveLogSoftmaxWithLoss
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        # print(args.tie_adaptive_weights)
        # args.tie_adaptive_weights=False
        if args.adaptive_softmax_cutoff is not None:
            if args.adaptive_softmax_type == "adaptive":
                self.adaptive_softmax = AdaptiveSoftmax(
                    ...
                    factor=eval(args.adaptive_softmax_factor),
                    tie_proj=args.tie_adaptive_proj,
                )
            elif args.adaptive_softmax_type == "twostep":
                self.adaptive_softmax = TwoStepSoftmax(
                    len(dictionary),
                    self.output_embed_dim,
                    utils.eval_str_list(args.adaptive_softmax_cutoff, type=int),
                    dropout=args.adaptive_softmax_dropout,
                    ...
                    factor=eval(args.adaptive_softmax_factor),
                    tie_proj=args.tie_adaptive_proj,
                    enable_gumbel_softmax=args.adaptive_softmax_gumbel,
                    return_head_loss=args.adaptive_softmax_head_loss,
                )
