...
class TransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def build_self_attention(
        ...
        self.avg_decoder_attn = args.avg_decoder_selfattn
        if self.attn_type == "selfattn":
            attn_func = MultiheadAttention
        elif self.attn_type == "rel_selfattn":
            attn_func = RelPositionMultiheadAttention
            ...
            exit(1)
        print("avg_attn:{}".format(self.avg_decoder_attn if self.attn_type == "selfattn" else False))
        ...
        return attn_func(
            ...
            q_noise=self.quant_noise,
            qn_block_size=self.quant_noise_block_size,
            average_attn= self.avg_decoder_attn if self.attn_type == "selfattn" else False
        )
